...
$caminho_img = filter_var( $_GET['caminho_img'], FILTER_SANITIZE_SPECIAL_CHARS);
    if( !isset( $id_img ) ):
        ...
        exit;
            ...
            $sql = "DELETE FROM imagem_casamento WHERE id_imagem ='$id_img' "; ///// apaga dados da tabela imagem
                ...
                if( $banco->exec($sql) ):
                    ...
                    echo" <script>document.location.href='../view/galeria_casamento.php'</script>";
                else:
