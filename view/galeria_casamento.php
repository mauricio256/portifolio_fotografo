<?php
    session_start();
    include_once('../controller/lista_imagens_casamento.php');
?>
            ...
            <div class="container-fluid">
                ...
                <?php else: ?> <!-- condição ALSE do IF acima, escapando HTML --> 
                    <?php foreach ($banco->query($sql) as $row) { ?>  <!-- foreach escapando HTML  para para percorrer a lista de resultado da consulta SQL -->
                                ...
                                <div class="col-lg-3">
                                    <div class="product-item">
                                        <form action="" method="GET">
                                            ...
                                            <a href="../controller/apagar_dados_imagem_casamento.php?id_imagem=<?php echo$row['id_imagem']?>&caminho_img=<?php echo$row['caminho']?>" style="background-color: gray; padding:5%; font-size:15px; color:white;"><img src="https://img.icons8.com/color/48/000000/delete-forever.png"/>DELETAR IMAGEM</a>
                                        </form>
                        ...
                        <?php } ?> <!-- fecha o foreach --> 
                        <a href="cadastrar_img_casamento.php" style=" margin:15px; text-align:center; padding:3%;"><hr>Adicionar nova imagem<img src="https://img.icons8.com/color/200/000000/add-image.png"/></a>
